...
{
    /// <summary>
    /// Документ "Акт прихода товара" в разделе "Управление продажами"
    /// </summary>
    public sealed class DocumentViewSaleActIn : BaseDocumentViewSale<DocumentSales>, IDocumentView
    {
        ...
        {
            DocumentViewSaleActIn newDoc = new DocumentViewSaleActIn();
        ...
        //protected void CreateAccountIn(int templateId = 98401)
        //{
        //    if (InvokeSave())
        //    {
        ...
        //        newDoc.Showing += delegate
        //        {
        //            newDoc.SourceDocument.Saved += delegate
        //            {
        //                List<Document> sourceList =BindingDocumentChains.DataSource as List<Document>;
        //                if (sourceList.FirstOrDefault(s => s.Id == newDoc.SourceDocument.Id) == null)
        //                {
        //                    BindingDocumentChains.Add(newDoc.SourceDocument.Document);
        //                }
        //            };
        //        };
        //        //newDoc.Showing += delegate
        ...
        //    }
        //}
        //protected void CreateOrderIn(int templateId = 98350)
        //{
        //    if (InvokeSave())
        //    {
        //        DocumentViewSaleOrderIn newDoc = new DocumentViewSaleOrderIn();
        //        newDoc.Showing += delegate
        //        {
        //            int currentAgentFromId = (int)ControlMain.cmbAgentFrom.EditValue;
        //            int currentAgentToId = (int)ControlMain.cmbAgentTo.EditValue;
        ...
        //    }
        //}
        //protected void CreateTaxIn(int templateId = 98400)
        //{
        //    if (InvokeSave())
        //    {
        //        DocumentViewTaxIn newDoc = new DocumentViewTaxIn();
        //        newDoc.Showing += delegate
        //        {
        //            int currentAgentFromId = (int)ControlMain.cmbAgentFrom.EditValue;
        //            int currentAgentToId = (int)ControlMain.cmbAgentTo.EditValue;
        ...
        //    }
        //}
        //protected void CreateReturnSupplyer(int templateId = 98402)
        //{
        //    if (InvokeSave())
        //    {
        //        DocumentViewSaleReturnSupplyer newDoc = new DocumentViewSaleReturnSupplyer();
        //        newDoc.Showing += delegate
        //        {
        //            int currentAgentFromId = (int)ControlMain.cmbAgentFrom.EditValue;
        //            int currentAgentToId = (int)ControlMain.cmbAgentTo.EditValue;
        ...
        //    }
        //}
        //protected void CreatePriceList(int templateId = 98352)
        //{
        //    if (InvokeSave())
        //    {
        ...
        //            break;
        //        case "CREATERETURNSUPPLYER":
        //            CreateReturnSupplyer(v.Id);
        //            break;
        //        case "CREATETAXIN":
        //            CreateTaxIn(v.Id);
        //            break;
...
"; Адрес: " + {Document.AgentFromAddres}
        ...
        //{
        //    DevExpress.XtraNavBar.NavBarItem navBarItemCreateAccountIn = new DevExpress.XtraNavBar.NavBarItem
        //                                                                     {
        //                                                                         Caption = "Создать счет...",
        //                                                                         SmallImage = ExtentionsImage.GetImageDocument(Workarea, State.STATEACTIVE)
        //                                                                     };
        //    navBarItemCreateAccountIn.LinkClicked += delegate
        //    {
        //        CreateAccountIn();
        //    };
        //    DevExpress.XtraNavBar.NavBarItem navBarItemCreateOrderIn = new DevExpress.XtraNavBar.NavBarItem
        //                                                                   {
        //                                                                       Caption = "Создать заказ покупателя...",
        //                                                                       SmallImage = ExtentionsImage.GetImageDocument(Workarea, State.STATEACTIVE)
        //                                                                   };
        //    navBarItemCreateOrderIn.LinkClicked += delegate
        //    {
        //        CreateOrderIn();
        //    };
        //    DevExpress.XtraNavBar.NavBarItem navBarItemCreateReturnSupplyer = new DevExpress.XtraNavBar.NavBarItem
        //                                                                          {
        //                                                                              Caption = "Создать возврат поставщику...",
        //                                                                              SmallImage = ExtentionsImage.GetImageDocument(Workarea, State.STATEACTIVE)
        //                                                                          };
        //    navBarItemCreateReturnSupplyer.LinkClicked += delegate
        //    {
        //        CreateReturnSupplyer();
        //    };
        //    DevExpress.XtraNavBar.NavBarItem navBarItemCreateTaxIn = new DevExpress.XtraNavBar.NavBarItem
        //                                                                 {
        //                                                                     Caption = "Создать налоговую...",
        //                                                                     SmallImage = ExtentionsImage.GetImageDocument(Workarea, State.STATEACTIVE)
        //                                                                 };
        //    navBarItemCreateTaxIn.LinkClicked += delegate
        //    {
        //        CreateTaxIn();
        //    };
        //    DevExpress.XtraNavBar.NavBarItem navBarItemCreatePriceList = new DevExpress.XtraNavBar.NavBarItem
        //                                                                     {
        //                                                                         Caption = "Создать прайс-лист...",
        //                                                                         SmallImage = ExtentionsImage.GetImageDocument(Workarea, State.STATEACTIVE)
        //                                                                     };
        //    navBarItemCreatePriceList.LinkClicked += delegate
        //    {
        //        CreatePriceList();
        //    };
        //    ControlMain.navBarControl.Items.AddRange(new[]
        //                                          {
        //                                              navBarItemCreateAccountIn,
        //                                              navBarItemCreateOrderIn,
        //                                              navBarItemCreateReturnSupplyer,
        //                                              navBarItemCreateTaxIn,
        //                                              navBarItemCreatePriceList
        //                                          });
        //    ControlMain.navBarGroupActions.ItemLinks.AddRange(new[] {
        //        new DevExpress.XtraNavBar.NavBarItemLink(navBarItemCreateAccountIn),
        //        new DevExpress.XtraNavBar.NavBarItemLink(navBarItemCreateOrderIn),
        //        new DevExpress.XtraNavBar.NavBarItemLink(navBarItemCreateReturnSupplyer),
        //        new DevExpress.XtraNavBar.NavBarItemLink(navBarItemCreateTaxIn),
        //        new DevExpress.XtraNavBar.NavBarItemLink(navBarItemCreatePriceList)
        //        });
        //}
        ...
        //public override bool ValidateRuleSet()
        //{

        //    /*
        //     Ruleset ruleset = value.Workarea.Cashe.GetCasheData<Ruleset>().ItemCode(key);
        ...
        public override bool InvokeSave()
        {
            ...
            try
            {
                ...
                // Добавить расчет _sourceDocument.Document.SummaBase - соответствует сумме документа
                // Добавить расчет _sourceDocument.Document.SummaTax - соответствует сумме налогов (НДС) документа, в зависимоти от выбранных налогов для документа
                // Добавить расчет _sourceDocument.Document.SummaTotal - (_sourceDocument.Document.SummaTax + _sourceDocument.Document.Summa)  документа
        ...
        {
            if ((BindSourceDetails.List[e.ListSourceRow] as DocumentDetailSale).StateId == 5)
            {
                e.Visible = false;
                e.Handled = true;
            }
            ...
            try
            {
                ...
                else if (cmb.Name == "cmbAgentTo" && BindSourceAgentTo.Count < 2)
                {
                    ...
                    if (rootMyCompany != null)
                        CollectionAgentTo = rootMyCompany.GetTypeContents<Agent>().Where(f => f.KindValue == Agent.KINDVALUE_MYCOMPANY && !f.IsHiden).ToList();
                    else
                        CollectionAgentTo = Workarea.GetCollection<Agent>(Agent.KINDVALUE_MYCOMPANY).Where(f => f.KindValue == Agent.KINDVALUE_MYCOMPANY && !f.IsHiden).ToList();
