...
{
    /// <summary>
    /// Построитель виртуальных иерархий по товарным группам 
    /// </summary>
    public class VirtualHierarchyProductGroup : IVirtualGroupBuilder<Product>
    {
        /// <summary>
        ...
        public List<IVirtualGroup<Product>> Roots()
        {
            if (_root == null)
            {
                ...
                //
                Hierarchy analiticRoot = _hierarchy.Workarea.Cashe.GetCasheData<Hierarchy>().ItemCode<Hierarchy>("TRADEMARK");
