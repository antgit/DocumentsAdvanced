...
{
    /// <summary>
    /// Подготовка печатного документа в разделе "Управление услугами"
    /// </summary>
    public class PreparePrintServices
    {
        /// <summary>
        /// Конструктор
        /// </summary>
        public PreparePrintServices()
        {

        }

        private DocumentService _sourceDocument;

        /// <summary>
        /// Документ для печати
        /// </summary>
        public DocumentService SourceDocument
        {
