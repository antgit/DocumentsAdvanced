...
{
    /// <summary>
    /// Документ "Приказ" в разделе "Управление договорами"
    /// </summary>
    public class DocumentViewCommand : BaseDocumentViewContract<DocumentContract>, IDocumentView
    {
        #region Fields
        ...
        {
            DocumentViewCommand newDoc = new DocumentViewCommand();
