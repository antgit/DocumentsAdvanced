...
{
    /// <summary>
    /// Документ "Письмо исходящее" в разделе "Управление договорами"
    /// </summary>
    public class DocumentViewLetterOut : BaseDocumentViewContract<DocumentContract>, IDocumentView
    {
        #region Fields
        ...
        {
            DocumentViewLetterOut newDoc = new DocumentViewLetterOut();
