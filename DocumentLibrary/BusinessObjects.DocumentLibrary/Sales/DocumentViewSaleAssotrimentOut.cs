...
{
    /// <summary>
    /// Документ "Ассортиментный лист исходящий" в разделе "Управление продажами"
    /// </summary>
    public sealed class DocumentViewSaleAssotrimentOut : BaseDocumentViewSale<DocumentSales>, IDocumentView
    {
        /// <summary>
        ...
        {
            DocumentViewSaleAssotrimentOut newDoc = new DocumentViewSaleAssotrimentOut();
