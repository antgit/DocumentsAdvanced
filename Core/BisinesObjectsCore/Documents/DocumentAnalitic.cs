...
{
    internal struct BaseStructDocumentAnalitic
    {
    ...
    /// <summary>
    /// Дополнительная аналитика для документа
    /// </summary>
    public sealed class DocumentAnalitic : DocumentBaseDetail, IEditableObject
    {
        /// <summary>
        /// Конструктор
        /// </summary>
        public DocumentAnalitic()
            : base()
        {
        ...
        internal class TpvCollection : List<DocumentAnalitic>, IEnumerable<SqlDataRecord>
        {
            IEnumerator<SqlDataRecord> IEnumerable<SqlDataRecord>.GetEnumerator()
            {
                ...
                foreach (DocumentAnalitic doc in this)
                {
        ...
        internal static IDataRecord FillDataRecort(SqlDataRecord sdr, DocumentAnalitic doc)
        {
