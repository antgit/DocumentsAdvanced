...
{
    /// <summary>
    /// Документ "Договор поставки по видам продукции" в разделе "Управление договорами"
    /// </summary>
    public class DocumentViewСontractByProduct : BaseDocumentViewContract<DocumentContract>, IDocumentView
    {
        #region Fields
        ...
        {
            DocumentViewСontractByProduct newDoc = new DocumentViewСontractByProduct();
        ...
        public override bool InvokeSave()
        {
            ...
            {
                DevExpress.XtraEditors.XtraMessageBox.Show(Workarea.Cashe.ResourceString(ResourceString.EX_MSG_ERRORSAVE, 1049) +
