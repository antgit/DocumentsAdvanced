...
namespace BusinessObjects.Documents
{
    ...
    /// Финансовый документ
    /// </summary>
    public class DocumentFinance : DocumentBase, IEditableObject, IChainsAdvancedList<Document, FileData>
    {
        ...
        /// <summary>Настройки раздела, соответствует значению 393316</summary>
        public const int KINDID_CONFIG = 393316;
        ...
        {
            EntityId = 6;
            _details = new List<DocumentDetailFinance>();
        ...
        public AgentBankAccount AgFromBankAcc
        {
            ...
            set
            {
                ...
                OnPropertyChanged("AgFromBankAcc");
            }
        }
        ...
        public int PaymentTypeId
        {
            ...
            set
            {
                if (value == _paymentTypeId) return;
                OnPropertyChanging(GlobalPropertyNames.PaymentTypeId);
                _paymentTypeId = value;
                OnPropertyChanged(GlobalPropertyNames.PaymentTypeId);
            }
        }

        private Analitic _paymentType;
        /// <summary>
        /// Тип платежа
        /// </summary>
        public Analitic PaymentType
        {
            get
            {
                if (_paymentTypeId == 0)
                ...
                if (_paymentType == null)
                    _paymentType = Workarea.Cashe.GetCasheData<Analitic>().Item(_paymentTypeId);
                else if (_paymentType.Id != _paymentTypeId)
                    _paymentType = Workarea.Cashe.GetCasheData<Analitic>().Item(_paymentTypeId);
                return _paymentType;
            }
            set
            {
                ...
                OnPropertyChanging(GlobalPropertyNames.PaymentType);
                _paymentType = value;
                _paymentTypeId = _paymentType == null ? 0 : _paymentType.Id;
                OnPropertyChanged(GlobalPropertyNames.PaymentType);
            }
        }
        
        
        internal List<DocumentDetailFinance> _details;
        /// <summary>
        /// Детализация финансового документа
        /// </summary>
        public List<DocumentDetailFinance> Details
        {
            get { return _details; }
            set { _details = value; }
        }
        ...
        protected override void WritePartialXml(XmlWriter writer)
        {
            ...
            if (_paymentTypeId != 0)
                writer.WriteAttributeString(GlobalPropertyNames.PaymentTypeId, XmlConvert.ToString(_paymentTypeId));
        }
        ...
        protected override void ReadPartialXml(XmlReader reader)
        {
            ...
            if (reader.GetAttribute(GlobalPropertyNames.PaymentTypeId) != null)
                _paymentTypeId = XmlConvert.ToInt32(reader.GetAttribute(GlobalPropertyNames.PaymentTypeId));
        }
        #endregion
        ...
        /// </summary>
        /// <returns></returns>
        public DocumentDetailFinance NewRow()
        {
            DocumentDetailFinance row = new DocumentDetailFinance
            {
                Workarea = Workarea,
                Document = this,
        ...
        public override void Validate()
        {
            ...
            Document.Validate();
            base.Validate();
            foreach (DocumentDetailFinance row in _details)
            {
                if (Workarea.IsWebApplication)
                            ...
                            if (reader.Read() && reader.HasRows)
                            {
                                ...
                                if (reader.NextResult())
                                {
                                    if (reader.HasRows)
                                    {
                                        while (reader.Read())
                                        {
                                            DocumentDetailFinance docRow = new DocumentDetailFinance { Workarea = Workarea, Document = this };
                                            docRow.Load(reader);
                                            _details.Add(docRow);
                                        }
                                    }
        ...
        public static DocumentFinance CreateCopy(DocumentFinance value)
        {

            DocumentFinance doc = new DocumentFinance { Workarea = value.Workarea };
                            ...
                            if (reader.Read() && reader.HasRows)
                            {
                                ...
                                if (reader.NextResult())
                                {
                                    if (reader.HasRows)
                                    {
                                        while (reader.Read())
                                        {
                                            DocumentDetailFinance docRow = new DocumentDetailFinance { Workarea = value.Workarea, Document = doc };
                                            docRow.Load(reader);
        ...
        public override void Load(SqlDataReader reader, bool endInit = true)
        {
            ...
            try
            {
                ...
                _paymentTypeId = reader.IsDBNull(11) ? 0 : reader.GetInt32(11);
                _agFromBankAccId = reader.IsDBNull(12) ? 0 : reader.GetInt32(12);
                _agToBankAccId = reader.IsDBNull(13) ? 0 : reader.GetInt32(13);
            }
            catch(Exception ex)
            {
        ...
        internal class TpvCollection : List<DocumentFinance>, IEnumerable<SqlDataRecord>
        {
            IEnumerator<SqlDataRecord> IEnumerable<SqlDataRecord>.GetEnumerator()
            {
                ...
                (
                    ...
                    new SqlMetaData(GlobalPropertyNames.PaymentTypeId, SqlDbType.Int),
                ...
                foreach (DocumentFinance doc in this)
                {
        ...
        internal static IDataRecord FillDataRecort(SqlDataRecord sdr, DocumentFinance doc)
        {
        ...
        protected override void SetParametersToInsertUpdate(SqlCommand sqlCmd, bool insertCommand, bool validateVersion)
        {
            ...
            DocumentDetailFinance.TpvCollection collRows = new DocumentDetailFinance.TpvCollection();
