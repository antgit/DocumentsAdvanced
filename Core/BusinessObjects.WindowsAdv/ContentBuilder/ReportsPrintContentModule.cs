...
{
    /// <summary>
    /// Модуль "Печатные отчеты"
    /// </summary>
    public class ReportsPrintContentModule : ContentModuleBase<Library>
    {
        /// <summary>
        /// Конструктор
        /// </summary>
        ...
        /// отображения модуля.
        /// Заголовок модуля по умолчанию - "Печатные отчеты".
        ...
        /// </remarks>
        public ReportsPrintContentModule()
        {
            Caption = "Печатные отчеты";
            Show += ContentModuleShow;
            CreateControlTreeList += ContentModuleCreateTreeList;
            TYPENAME = "REPORTSPRINT";
            Key = TYPENAME + "_MODULE";
            RootCode = "REPORTSPRINTMODULEDATA";
            RestrictedTemplateKinds.Add(Library.KINDVALUE_REPPRINT);
