...
{
    /// <summary>
    /// Документ "Расходная накладная" в разделе "Управление товарными запасами"
    /// </summary>
    public sealed class DocumentViewStoreOut : BaseDocumentViewStore<DocumentStore>, IDocumentView
    {
        ...
        {
            DocumentViewStoreOut newDoc = new DocumentViewStoreOut();
