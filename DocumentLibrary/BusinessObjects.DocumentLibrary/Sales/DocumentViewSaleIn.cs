...
{
    /// <summary>
    /// Документ "Приходная накладная" в разделе "Управление продажами"
    /// </summary>
    public sealed class DocumentViewSaleIn : BaseDocumentViewSale<DocumentSales>, IDocumentView
    {
        ...
        {
            DocumentViewSaleIn newDoc = new DocumentViewSaleIn();
            ...
            try
            {
                ...
                else if (cmb.Name == "cmbAgentTo" && BindSourceAgentTo.Count < 2)
                {
                    ...
                    if(rootMyCompany!=null)
                        ...
                        CollectionAgentTo = Workarea.GetCollection<Agent>(4).Where(f => f.KindValue == Agent.KINDVALUE_MYCOMPANY && !f.IsHiden).ToList();
