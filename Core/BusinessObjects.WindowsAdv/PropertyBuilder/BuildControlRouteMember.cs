...
{
    /// <summary>
    /// Формирование контрола для отображения свойств участника маршрута
    /// </summary>
    internal sealed class BuildControlRouteMember : BasePropertyControlIBase<RouteMember>
    {
        /// <summary>
        /// Конструктор
        /// </summary>
        public BuildControlRouteMember()
            : base()
        {
        ...
        protected override void BuildPageCommon()
        {
            if (_common == null)
            {
                ...
                UIHelper.GenerateTooltips<RouteMember>(SelectedItem, _common);
