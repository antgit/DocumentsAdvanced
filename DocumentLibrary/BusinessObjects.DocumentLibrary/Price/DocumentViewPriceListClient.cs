...
{
    /// <summary>
    /// Документ "Прайс-лист индивидуальный" в разделе "Ценовая плолитика"
    /// </summary>
    /// <remarks>Документ для учета цен и выполнения расчетов цен.</remarks>
    public sealed class DocumentViewPriceListClient : BaseDocumentViewPrice<DocumentPrices>, IDocumentView
    {
        /// <summary>
        /// Конструктор
        /// </summary>
        public DocumentViewPriceListClient()
            : base()
        {
        ...
        {
            DocumentViewPriceListClient newDoc = new DocumentViewPriceListClient();
