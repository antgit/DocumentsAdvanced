...
namespace BusinessObjects.Windows
{
    ...
    /// </summary>
    internal sealed class BuildControlAnalitic : BasePropertyControlIBase<Analitic>
    {
        /// <summary>
        /// Конструктор
        /// </summary>
        public BuildControlAnalitic()
            : base()
        {
        ...
        protected override void BuildPageCommon()
        {
            if (_common == null)
            {
                ...
                UIHelper.GenerateTooltips<Analitic>(SelectedItem, _common);
