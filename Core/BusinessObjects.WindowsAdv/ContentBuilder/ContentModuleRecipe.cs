...
{
    /// <summary>
    /// Интерфейсный модуль "Комплекты и наборы"
    /// </summary>
    public sealed class ContentModuleRecipe : ContentModuleBase<Recipe>
    {
        /// <summary>
        /// Конструктор
        /// </summary>
        ...
        /// отображения модуля.
        /// Заголовок модуля по умолчанию - "Комплекты и наборы".
        ...
        /// </remarks>
        public ContentModuleRecipe()
        {
            Caption = "Комплекты и наборы";
        ...
        /// <remarks>После отображения свойств объекта он добавляется в текущий список.</remarks>
        /// <param name="value">Объект для отображения</param>
        void OnShowPropTreeList(Recipe value)
        {
            value.ShowProperty();
            if (value.IsNew)
            {
        ...
        void OnSaveObject(Recipe value)
        {
            value.Save();
        }
        /// <summary>
        ...
        void ContentModuleShow(object sender, EventArgs e)
        {
            if (BrowserBaseObjects != null)
            {
                if (_showProp == null)
                {
                    _showProp = new Action<Recipe>(OnShowProp);
            ...
            if (TreeListBrowser != null)
            {
                ...
                {
                    _showPropTreeList = new Action<Recipe>(OnShowPropTreeList);
                    TreeListBrowser.ListBrowserBaseObjects.ShowProperty += _showPropTreeList;
                }
                if (_saveAnalitic == null)
                {
                    _saveAnalitic = new Action<Recipe>(OnSaveObject);
