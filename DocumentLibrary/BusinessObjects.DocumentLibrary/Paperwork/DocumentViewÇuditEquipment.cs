...
{
    /// <summary>
    /// Документ "Ревизия оборудования" в разделе "Управление договорами"
    /// </summary>
    public class DocumentViewАuditEquipment : BaseDocumentViewContract<DocumentContract>, IDocumentView
    {
        #region Fields
        ...
        {
            DocumentViewАuditEquipment newDoc = new DocumentViewАuditEquipment();
