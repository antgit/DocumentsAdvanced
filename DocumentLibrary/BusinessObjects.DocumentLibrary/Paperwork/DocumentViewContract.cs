...
{
    /// <summary>
    /// Документ "Договор" в разделе "Управление договорами"
    /// </summary>
    public class DocumentViewContract : BaseDocumentViewContract<DocumentContract>, IDocumentView
    {
        #region Fields
        ...
        {
            DocumentViewContract newDoc = new DocumentViewContract();
