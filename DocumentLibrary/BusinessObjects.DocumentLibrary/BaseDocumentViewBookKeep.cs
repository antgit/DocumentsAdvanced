...
{
    /// <summary>
    /// Абстракный класс внешненго представления документа в разделе "Бухгалтерия"
    /// </summary>
    public abstract class BaseDocumentViewBookKeep<T> : BaseDocumentView<T> where T : class, IDocument, new()
    {
        /// <summary>
        /// Элемент отображения главной страницы
        /// </summary>
        internal ControlBookKeep ControlMain { get; set; }
