...
namespace BusinessObjects.DocumentLibrary.Person
{
    ...
    /// </summary>
    public sealed class DocumentViewPersonMove : BaseDocumentViewPerson<DocumentPerson>, IDocumentView
    {
        #region Создание копии и нового документа
        protected override void CreateCopy()
        {
            DocumentViewPersonMove newDoc = new DocumentViewPersonMove();
