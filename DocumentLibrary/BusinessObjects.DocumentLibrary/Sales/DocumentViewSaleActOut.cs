...
{
    /// <summary>
    /// Документ "Акт списания товара" в разделе "Управление продажами"
    /// </summary>
    public sealed class DocumentViewSaleActOut : BaseDocumentViewSale<DocumentSales>, IDocumentView
    {
        /// <summary>
        ...
        {
            DocumentViewSaleActOut newDoc = new DocumentViewSaleActOut();
