...
{
    /// <summary>
    /// Документ "Возврат поставщику" в разделе "Управление товарными запасами"
    /// </summary>
    public sealed class DocumentViewStoreReturnSupplyer : BaseDocumentViewStore<DocumentStore>, IDocumentView
    {
        ...
        public override void BuildPageCommon()
        {
            if (ControlMain == null)
            {
                ...
                Form.btnSaveClose.Visibility = DevExpress.XtraBars.BarItemVisibility.Always;
        ...
        void BtnSaveCloseItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (InvokeSave())
                Form.Close();
        }
        // Обработка события "Сохранить"
        void BtnSaveItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            InvokeSave();
        }
        ...
        public override bool InvokeSave()
        {
            ...
            SourceDocument.Document.AgentDepartmentFromId = (int)ControlMain.cmbAgentStoreFrom.EditValue;
