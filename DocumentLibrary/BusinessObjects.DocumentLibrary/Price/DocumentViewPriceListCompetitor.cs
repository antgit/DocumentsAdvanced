...
{
    /// <summary>
    /// Документ "Прайс-лист конкурента" в разделе "Ценовая плолитика"
    /// </summary>
    /// <remarks>Документ для учета цен и выполнения расчетов цен.</remarks>
    public sealed class DocumentViewPriceListCompetitor : BaseDocumentViewPrice<DocumentPrices>, IDocumentView
    {
        /// <summary>
        /// Конструктор
        /// </summary>
        public DocumentViewPriceListCompetitor()
            : base()
        {
        ...
        {
            DocumentViewPriceListCompetitor newDoc = new DocumentViewPriceListCompetitor();
