...
{
    /// <summary>
    /// Абстракный класс внешненго представления документа в разделе "Ценовая политика"
    /// </summary>
    public abstract class BaseDocumentViewPrice<T> : BaseDocumentView<T> where T : class, IDocument, new()
    {
        /// <summary>
        ...
        /// </summary>
        internal ControlPrices ControlMain { get; set; }
