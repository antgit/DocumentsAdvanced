...
{
    /// <summary>
    /// Документ "Акт выполненых работ" в разделе "Услуги"
    /// </summary>
    public sealed class DocumentViewServiceActOut : BaseDocumentViewService<DocumentService>, IDocumentView
    {
        /// <summary>
        ...
        {
            DocumentViewServiceActOut newDoc = new DocumentViewServiceActOut();
