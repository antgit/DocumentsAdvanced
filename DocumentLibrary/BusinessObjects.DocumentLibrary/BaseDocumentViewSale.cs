...
{
    /// <summary>
    /// Абстракный класс внешненго представления документа в разделе "Торговля"
    /// </summary>
    public abstract class BaseDocumentViewSale<T> : BaseDocumentView<T> where T : class, IDocument, new()
    {
        /// <summary>
        ...
        /// <summary>
        /// Коллекция корреспондентов "Перевозчик"
        /// </summary>
        protected List<Agent> CollectionAgentDelivery;
        /// <summary>
        /// Коллекция корреспондентов "Склад"
        /// </summary>
        protected List<Agent> CollectionStoreFrom;
        /// <summary>
        /// Коллекция корреспондентов "Склад контрагента"
        /// </summary>
        protected List<Agent> CollectionStoreTo;
        /// <summary>
        /// Коллекция "Ценовая политика"
        /// </summary>
        protected List<PriceName> CollectionPrice;
        /// <summary>
        /// Источники для связывания корреспондентов "Перевозчик"
        /// </summary>
        public BindingSource BindSourceAgentDelivery;
        /// <summary>
        /// Источники для связывания корреспондентов "Склад"
        /// </summary>
        public BindingSource BindSourceStoreFrom;
        /// <summary>
        /// Источники для связывания корреспондентов "Склад контрагента"
        /// </summary>
        public BindingSource BindSourceStoreTo;
        /// <summary>
        ...
        /// </summary>
        internal ControlSales ControlMain { get; set; }
        ...
        protected virtual void RefreshEditEnabled()
        {
            ...
            if (SourceDocument.Document.AgentDepartmentFromId == (SourceDocument as DocumentSales).StoreFromId)
                ControlMain.cmbAgentStoreFrom.Enabled = false;
            if (SourceDocument.Document.AgentDepartmentToId == (SourceDocument as DocumentSales).StoreToId)
