...
{
    /// <summary>
    /// Документ "Приказ на изменение цен" в разделе "Ценовая плолитика"
    /// </summary>
    /// <remarks>Документ для учета цен и выполнения расчетов цен.</remarks>
    public sealed class DocumentViewPriceListCommand : BaseDocumentViewPrice<DocumentPrices>, IDocumentView
    {
        /// <summary>
        /// Конструктор
        /// </summary>
        public DocumentViewPriceListCommand()
            : base()
        {
        ...
        {
            DocumentViewPriceListCommand newDoc = new DocumentViewPriceListCommand();
