...
{
    /// <summary>
    /// Документ "Заказ поставщику" в разделе "Услуги"
    /// </summary>
    public sealed class DocumentViewServiceOrderIn : BaseDocumentViewService<DocumentService>, IDocumentView
    {
        /// <summary>
        ...
        {
            DocumentViewServiceOrderIn newDoc = new DocumentViewServiceOrderIn();
