...
{
    /// <summary>
    /// Входящая корректировочная налоговая накладная
    /// </summary>
    public sealed class DocumentViewTaxCorIn : BaseDocumentViewTaxes<DocumentTaxes>, IDocumentView
    {
        ...
        {
            DocumentViewTaxCorIn newDoc = new DocumentViewTaxCorIn();
        ...
        void CmbAgentDepatmentFromEditValueChanged(object sender, EventArgs e)
        {
            ...
            //    ControlMain.cmbDelivery.EditValue = CollectionAgentDelivery[0].Id;
            //else
            ...
            //ControlMain.cmbStore.Properties.DataSource = BindSourceStore;
            //if (CollectionStore.Count > 0)
            //    ControlMain.cmbStore.EditValue = CollectionStore[0].Id;
            //else
            //    ControlMain.cmbStore.EditValue = 0;
        }
        ...
        void CmbAgentGridLookUpEditQueryPopUp(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    CollectionAgentFrom = Workarea.GetCollection<Agent>().Where(s => !s.IsMyCompany && s.IsCompanyOnly).ToList();
                ...
                {
                    CollectionAgentDepatmentTo = Agent.GetChainSourceList(Workarea, (int)ControlMain.cmbAgentFrom.EditValue, DocumentViewConfig.DepatmentChainId);
