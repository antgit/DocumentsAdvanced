...
{
    /// <summary>
    /// Документ "Заказ входящий" в разделе "Услуги"
    /// </summary>
    public sealed class DocumentViewServiceOrderOut : BaseDocumentViewService<DocumentService>, IDocumentView
    {
        /// <summary>
        ...
        {
            DocumentViewServiceOrderOut newDoc = new DocumentViewServiceOrderOut();
