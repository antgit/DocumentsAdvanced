...
{
    /// <summary>
    /// Документ "Заказ от покупателя" в разделе "Управление продажами"
    /// </summary>
    public sealed class DocumentViewSaleOrderIn : BaseDocumentViewSale<DocumentSales>, IDocumentView
    {
                        ...
                        if (SourceDocument.Document == null)
                        {
                            ...
                            SourceDocument.Kind = template.KindId;
                                                ...
                                                if (salesTemplate != null)
                                                {
                                                    ...
                                                    if (salesTemplate.Details.Count > 0 &&
                                                        SourceDocument.Details.Count == 0)
                                                    {
...
"; Адрес: " + {Document.AgentFromAddres}
        ...
        //        CreateAccountIn();
        //    };
        //    DevExpress.XtraNavBar.NavBarItem navBarItemCreateSalesIn = new DevExpress.XtraNavBar.NavBarItem
        //                                                                   {
        //                                                                       Caption = "Создать приходную наклладную...",
        //                                                                       SmallImage = ExtentionsImage.GetImageDocument(Workarea, State.STATEACTIVE)
        //                                                                   };
        //    navBarItemCreateSalesIn.LinkClicked += delegate
        //    {
        //        CreateSalesIn();
        //    };
        ...
        //        new DevExpress.XtraNavBar.NavBarItemLink(navBarItemCreateSalesIn),
        ...
        decimal GetPriceForProduct(int productId)
        {
            return PriceValue.GetActualPrice(Workarea, (int)ControlMain.cmbPrice.EditValue, productId,
                                      (int)ControlMain.cmbAgentDepatmentTo.EditValue, ControlMain.dtDate.DateTime);

        }
        // Выполнить добавление нового товара
        ...
        void ViewDetailCustomRowFilter(object sender, RowFilterEventArgs e)
        {
        ...
        void ViewAgentFromCustomUnboundColumnData(object sender, CustomColumnDataEventArgs e)
        {
            DisplayAgentImagesLookupGrid(e, BindSourceAgentFrom);
        }

        void ViewDepatmentFromCustomUnboundColumnData(object sender, CustomColumnDataEventArgs e)
        {
            DisplayAgentImagesLookupGrid(e, BindSourceAgentDepatmentFrom);
        }
        void ViewAgentToCustomUnboundColumnData(object sender, CustomColumnDataEventArgs e)
        {
            DisplayAgentImagesLookupGrid(e, BindSourceAgentTo);
        }
        void ViewDeliveryCustomUnboundColumnData(object sender, CustomColumnDataEventArgs e)
        {
            DisplayAgentImagesLookupGrid(e, BindSourceAgentDelivery);
        }
        void ViewDepatmentToCustomUnboundColumnData(object sender, CustomColumnDataEventArgs e)
        {
            DisplayAgentImagesLookupGrid(e, BindSourceAgentDepatmentTo);
        }
        void ViewStoreFromCustomUnboundColumnData(object sender, CustomColumnDataEventArgs e)
        {
            DisplayAgentImagesLookupGrid(e, BindSourceStoreFrom);
        }
        void ViewStoreToCustomUnboundColumnData(object sender, CustomColumnDataEventArgs e)
        {
        ...
        void ViewManagerCustomUnboundColumnData(object sender, CustomColumnDataEventArgs e)
        {
            DisplayAgentImagesLookupGrid(e, BindSourceAgentManager);
        }
        // Обработка отрисовки изображения списке корреспондента "Супервизор"
        void ViewSupervisorCustomUnboundColumnData(object sender, CustomColumnDataEventArgs e)
        {
