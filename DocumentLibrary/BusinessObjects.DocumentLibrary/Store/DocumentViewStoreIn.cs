...
{
    /// <summary>
    /// Документ "Приходная накладная" в разделе "Управление товарными запасами"
    /// </summary>
    public sealed class DocumentViewStoreIn : BaseDocumentViewStore<DocumentStore>, IDocumentView
    {
        ...
        {
            DocumentViewStoreIn newDoc = new DocumentViewStoreIn();
