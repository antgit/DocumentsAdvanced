...
{
    /// <summary>
    /// Документ "Фиксация товарных остатков" в разделе "Управление товарными запасами"
    /// </summary>
    public sealed class DocumentViewStoreFixProductRemain : BaseDocumentViewStore<DocumentStore>, IDocumentView
    {
        ...
        {
            DocumentViewStoreFixProductRemain newDoc = new DocumentViewStoreFixProductRemain();
        ...
        protected override void RegisterActionToolBar()
        {
            ...
            if (GroupLinksActionList == null)
            {
                ...
                menuActions.AddItem(new BarButtonItem { Caption = "Информация о документе" });
