...
{
    /// <summary>
    /// Документ "Счет исходящий" в разделе "Услуги"
    /// </summary>
    public sealed class DocumentViewServiceAccountOut : BaseDocumentViewService<DocumentService>, IDocumentView
    {
        /// <summary>
        /// Установка значений редакторов в документе
        /// </summary>
        ...
        public void SetEditorValues(object agFrom, object agDepFrom, object agentTo, object agDepTo, object store, object price, object date)
        {
        ...
        #region Создание копии, нового документа и привязанных документов
        // Создание копии
        protected override void CreateCopy()
        {
            DocumentViewServiceAccountOut newDoc = new DocumentViewServiceAccountOut();
        ...
        public override void BuildPageCommon()
        {
            if (ControlMain == null)
            {
                if (ControlMain != null)
                    return;
                ControlMain = new ControlService { Name = ExtentionString.CONTROL_COMMON_NAME };
                ...
                ControlMain.layoutControlItemDatePay.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Always;
                ...
                ControlMain.dtDatePay.EditValue = SourceDocument.DatePay;
        ...
        //{
        //    DevExpress.XtraNavBar.NavBarItem navBarItemCreateSalesOut = new DevExpress.XtraNavBar.NavBarItem
        //                                                                    {
        //                                                                        Caption = "Создать расходную накладную ...",
        //                                                                        SmallImage = ExtentionsImage.GetImageDocument(Workarea, State.STATEACTIVE)
        //                                                                    };
        //    navBarItemCreateSalesOut.LinkClicked += delegate
        //    {
        //        CreateSalesOut();
        //    };
        //    ControlMain.navBarControl.Items.AddRange(new[]
        //                                          {
        //                                              navBarItemCreateSalesOut
        //                                          });
        //    ControlMain.navBarGroupActions.ItemLinks.AddRange(new[] {
        //        new DevExpress.XtraNavBar.NavBarItemLink(navBarItemCreateSalesOut)
        //        });
        //}
        ...
        public override bool InvokeSave()
        {
            ...
            if (ControlMain.dtDatePay.EditValue != null)
                SourceDocument.DatePay = ControlMain.dtDatePay.DateTime;
            else
                SourceDocument.DatePay = null;
        ...
        {
            if ((BindSourceDetails.List[e.ListSourceRow] as DocumentDetailService).StateId == 5)
            {
                e.Visible = false;
                e.Handled = true;
            }
