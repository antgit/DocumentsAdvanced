...
{
    /// <summary>
    /// Модуль раздела "Управление договарами"
    /// </summary>
    public class ContentModuleDogovor : ContentModuleByFolders, IContentModule
    {
        public ContentModuleDogovor()
        {
            TYPENAME = "MODULEDOGOVOR";
            Caption = "Управление договорами";
        ...
        {
            Hierarchy rootData = Workarea.Cashe.GetCasheData<Hierarchy>().ItemCode<Hierarchy>("DOGOVOR");
