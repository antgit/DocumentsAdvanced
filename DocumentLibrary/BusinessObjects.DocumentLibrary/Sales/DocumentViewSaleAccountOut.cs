...
{
    /// <summary>
    /// Документ "Счет исходящий" в разделе "Управление продажами"
    /// </summary>
    public sealed class DocumentViewSaleAccountOut : BaseDocumentViewSale<DocumentSales>, IDocumentView
    {
        /// <summary>
        ...
        //protected void CreateSalesOut(int templateId = 98345)
        //{
        //    if (InvokeSave())
        //    {
        //        DocumentViewSaleOut newDoc = new DocumentViewSaleOut();
        //        newDoc.Showing += delegate
        //        {
        //            int currentAgentFromId = (int)ControlMain.cmbAgentFrom.EditValue;
        //            int currentAgentToId = (int)ControlMain.cmbAgentTo.EditValue;
        ...
        //            {
        //                //Chain<Document> chain = new Chain<Document>(SourceDocument.Document)
        //                //{
        //                //    RightId = newDoc.Id,
        //                //    KindId = 20,
