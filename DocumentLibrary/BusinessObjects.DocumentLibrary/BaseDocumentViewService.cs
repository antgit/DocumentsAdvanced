...
{
    /// <summary>
    /// Абстракный класс внешненго представления документа в разделе "Услуги"
    /// </summary>
    public abstract class BaseDocumentViewService<T> : BaseDocumentView<T> where T : class, IDocument, new()
    {
        /// <summary>
        ...
        /// </summary>
        internal ControlService ControlMain { get; set; }
