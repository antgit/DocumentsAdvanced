...
{
    /// <summary>
    /// Интерфейсный модуль "Интерактивные отчеты"
    /// </summary>
    public class ReportsContentModule : ContentModuleBase<Library>
    {
        /// <summary>
        /// Конструктор
        /// </summary>
        ...
        /// отображения модуля.
        /// Заголовок модуля по умолчанию - "Интеактивные отчеты".
        ...
        /// </remarks>
        public ReportsContentModule()
        {
            Caption = "Интеактивные отчеты";
            Show += ContentModuleShow;
            CreateControlTreeList += ContentModuleCreateTreeList;
            TYPENAME = "REPORTSINTERACTIVE";
            Key = TYPENAME + "_MODULE";
            RootCode = "REPORTSMODULEINTERACTIVEDATA";
            ShowProperiesOnDoudleClick = false;
            RestrictedTemplateKinds.Add(Library.KINDVALUE_REPTBL);
        }
