...
{
    /// <summary>
    /// Базовый класс финансовых документов
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public abstract class BaseDocumentViewFinance<T>:BaseDocumentView<T> where T : class, IDocument, new()
    {
        /// <summary>
        /// Коллекция аналитики "Тип платежа"
        /// </summary>
        protected List<Analitic> CollectionPaymentType;
        /// <summary>
        /// Источники для связывания аналитики "Тип платежа"
        /// </summary>
        public BindingSource BindSourcePaymentType;
        /// <summary>
        ...
        internal ControlFinance ControlMain;
