...
{
    /// <summary>
    /// Документ "Возврат покупателя" в разделе "Управление товарными запасами"
    /// </summary>
    public sealed class DocumentViewStoreReturnByer : BaseDocumentViewStore<DocumentStore>, IDocumentView
    {
