...
{
    /// <summary>
    /// Документ "Внутреннее перемещение" в разделе "Управление товарными запасами"
    /// </summary>
    public sealed class DocumentViewStoreMove : BaseDocumentViewStore<DocumentStore>, IDocumentView
    {
        ...
        public override void BuildPageCommon()
        {
            if (ControlMain == null)
            {
                ...
                ControlMain.layoutControlItemAgentFrom.Text = "Отправитель:";
                ControlMain.layoutControlItemAgentStoreFrom.Text = "Склад отправителя:";
                ControlMain.layoutControlItemAgentTo.Text = "Получатель :";
                ControlMain.layoutControlItemAgentStoreTo.Text = "Склад получателя:";
