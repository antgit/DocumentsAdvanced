...
{
    /// <summary>
    /// Документ "Служебная записка" в разделе "Управление договорами"
    /// </summary>
    public class DocumentViewOfficialNote : BaseDocumentView<DocumentContract>, IDocumentView //BaseDocumentViewContract<DocumentContract>, IDocumentView
    {
        ...
        // Обработка отрисовки изображения списке корреспондента "Сотрудник"
        ...
        // Обработка отрисовки изображения списке корреспондента "Получатель"
