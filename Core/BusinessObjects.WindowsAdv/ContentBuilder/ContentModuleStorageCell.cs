...
{
    /// <summary>
    /// Интерфейсный модуль "Ячейки хранения товара"
    /// </summary>
    public sealed class ContentModuleStorageCell : ContentModuleBase<StorageCell>
    {
        /// <summary>
        /// Конструктор
        /// </summary>
        ...
        /// отображения модуля.
        /// Заголовок модуля по умолчанию - "Ячейки хранения товара".
        ...
        /// </remarks>
        public ContentModuleStorageCell()
        {
            Caption = "Ячейки хранения товара";
        ...
        {
            Image32 = ResourceImage.GetByCode(Workarea, ResourceImage.CUBESYELLOW_X32);
        }
        /// <summary>
        /// Делегат отображения свойств объекта при отображении в виде списка
        /// </summary>
        Action<StorageCell> _showProp;
        /// <summary>
        /// Делегат отображения свойств объекта при отображении в виде групп
        /// </summary>
        Action<StorageCell> _showPropTreeList;
        /// <summary>
        /// Делегат сохранения объекта
        /// </summary>
        Action<StorageCell> _saveAnalitic;
        /// <summary>
        ...
        void OnShowProp(StorageCell value)
        {
            value.ShowProperty();
            if (value.IsNew)
            {
        ...
        /// <remarks>После отображения свойств объекта он добавляется в текущий список.</remarks>
        /// <param name="value">Объект для отображения</param>
        void OnShowPropTreeList(StorageCell value)
        {
            value.ShowProperty();
            if (value.IsNew)
            {
        ...
        void OnSaveObject(StorageCell value)
        {
            value.Save();
        }
        /// <summary>
        ...
        void ContentModuleShow(object sender, EventArgs e)
        {
            if (BrowserBaseObjects != null)
            {
                if (_showProp == null)
                {
                    _showProp = new Action<StorageCell>(OnShowProp);
            ...
            if (TreeListBrowser != null)
            {
                ...
                {
                    _showPropTreeList = new Action<StorageCell>(OnShowPropTreeList);
                    TreeListBrowser.ListBrowserBaseObjects.ShowProperty += _showPropTreeList;
                }
                if (_saveAnalitic == null)
                {
                    _saveAnalitic = new Action<StorageCell>(OnSaveObject);
