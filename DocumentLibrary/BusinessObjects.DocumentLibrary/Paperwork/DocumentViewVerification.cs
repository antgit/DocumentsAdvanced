...
{
    /// <summary>
    /// Документ "Акт сверки" в разделе "Управление договорами"
    /// </summary>
    public class DocumentViewVerification : BaseDocumentViewContract<DocumentContract>, IDocumentView
    {
        #region Fields
        ...
        {
            DocumentViewVerification newDoc = new DocumentViewVerification();
