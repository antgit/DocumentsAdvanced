...
{
    /// <summary>
    /// Документ "Заявки" в разделе "Управление договорами"
    /// </summary>
    public class DocumentViewDemand : BaseDocumentViewContract<DocumentContract>, IDocumentView
    {
        #region Fields
        ...
        {
            DocumentViewDemand newDoc = new DocumentViewDemand();
