...
namespace BusinessObjects.Windows
{
    public static partial class Extentions
    {
        ...
        /// <summary>
        /// Свойства объекта "График работ"
        /// </summary>
        /// <param name="item">График работ</param>
        /// <returns></returns>
        public static Form ShowProperty(this TimePeriod item)
        {
            InternalShowPropertyBase<TimePeriod> showPropertyBase = new InternalShowPropertyBase<TimePeriod>();
            showPropertyBase.SelectedItem = item;
            showPropertyBase.ControlBuilder = new BuildControlTimePeriod { SelectedItem = item };
            return showPropertyBase.ShowDialog();
        }
        #endregion

        /// <summary>
        /// Список объектов "График работ"
        /// </summary>
        /// <param name="item">Стартовый объект</param>
        /// <returns>Выбранный объект</returns>
        public static TimePeriod BrowseList(this TimePeriod item)
        {
            List<TimePeriod> col = BrowseMultyList(item, item.Workarea, null, null, false);
        ...
        /// <summary>
        /// Показать спикок объектов "График работ"
        /// </summary>
        ...
        /// <returns></returns>
        public static List<TimePeriod> BrowseList(this TimePeriod item, Predicate<TimePeriod> filter, List<TimePeriod> sourceCollection, string rootCode = null)
        {
            return BrowseMultyList(item, item.Workarea, filter, sourceCollection, true, rootCode);
        }
        internal static List<TimePeriod> BrowseMultyList(this TimePeriod item, Workarea wa, Predicate<TimePeriod> filter, List<TimePeriod> sourceCollection, bool allowMultySelect, string rootCode = null)
        {
            List<TimePeriod> returnValue = null;
            FormProperties frm = new FormProperties();
            Bitmap img = ExtentionsImage.GetImage(wa.Empty<TimePeriod>().Entity);
            frm.Ribbon.ApplicationIcon = img;
            frm.Icon = Icon.FromHandle(img.GetHicon());

            ListBrowserBaseObjects<TimePeriod> browserBaseObjects = new ListBrowserBaseObjects<TimePeriod>(wa, sourceCollection, filter, item, true, false, false, true) { Owner = frm, RootCode = rootCode };
            ...
            browserBaseObjects.ShowProperty += delegate(TimePeriod obj)
            {
                obj.ShowProperty();
                if (obj.IsNew)
                {
        ...
        public static List<TimePeriod> BrowseContent(this TimePeriod item, Workarea wa = null)
        {
            ContentModuleTimePeriod module = new ContentModuleTimePeriod();
