...
{
    /// <summary>
    /// Модуль "Просмотр остатков товара"
    /// </summary>
    public class ContentModuleSaleLeave : IContentModule
    {
        ...
        private const string TYPENAME = "SYSTEM_SALESLEAVE";
        // ReSharper restore InconsistentNaming

        public ContentModuleSaleLeave()
        {
            Caption = "Просмотр остатков товара";
        ...
        {
            Image32 = ResourceImage.GetByCode(Workarea, ResourceImage.ACTION_X32);
        }
        ...
        private void InvokeRefresh()
        {
            ...
            try
            {
                _bindingSourceData.DataSource = Sales.GetProductListLeaveCurrent(Workarea);
                _control.Grid.DataSource = _bindingSourceData;
            }
            finally
            {
        ...
        public void ShowNewWindows()
        {
            ...
            Bitmap img = ResourceImage.GetByCode(Workarea, ResourceImage.ACTION_X32);
            frm.Ribbon.ApplicationIcon = img;
            frm.Icon = Icon.FromHandle(img.GetHicon());
            ContentNavigator navigator = new ContentNavigator { MainForm = frm, Workarea = Workarea };


            IContentModule module = new ContentModuleSaleLeave();
