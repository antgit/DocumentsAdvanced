...
{
    /// <summary>
    /// Документ "Ассортиментный лист входящий" в разделе "Управление продажами"
    /// </summary>
    public sealed class DocumentViewSaleAssotrimentIn : BaseDocumentViewSale<DocumentSales>, IDocumentView
    {
        /// <summary>
        ...
        {
            DocumentViewSaleAssotrimentIn newDoc = new DocumentViewSaleAssotrimentIn();
