...
{
    /// <summary>
    /// Документ "Заказ поставщику" в разделе "Управление продажами"
    /// </summary>
    public sealed class DocumentViewSaleOrderOut : BaseDocumentViewSale<DocumentSales>, IDocumentView
    {
...
"; Адрес: " + {Document.AgentFromAddres}
        ...
        //                                          {
        //                                              navBarItemCreateAccountOut,
        //                                              navBarItemCreateSalesIn
        //                                          });
        //    ControlMain.navBarGroupActions.ItemLinks.AddRange(new[] {
        //        new DevExpress.XtraNavBar.NavBarItemLink(navBarItemCreateAccountOut),
            ...
            try
            {
                ...
                if (cmb.Name == "cmbAgentFrom" && BindSourceAgentFrom.Count < 2)
                {
                    ...
                    if (rootMyCompany != null)
                        ...
                        CollectionAgentFrom = Workarea.GetCollection<Agent>(4).Where(f => f.KindValue == Agent.KINDVALUE_MYCOMPANY && !f.IsHiden).ToList();
