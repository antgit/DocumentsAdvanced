...
{
    /// <summary>
    /// Документ "Письмо входящее" в разделе "Управление договорами"
    /// </summary>
    public class DocumentViewLetterIn : BaseDocumentViewContract<DocumentContract>, IDocumentView
    {
        #region Fields
        ...
        {
            DocumentViewLetterIn newDoc = new DocumentViewLetterIn();
