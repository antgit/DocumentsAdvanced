...
{
    /// <summary>
    /// Документ "Счет входящий" в разделе "Услуги"
    /// </summary>
    public sealed class DocumentViewServiceAccountIn : BaseDocumentViewService<DocumentService>, IDocumentView
    {
        /// <summary>
        ...
        {
            DocumentViewServiceAccountIn newDoc = new DocumentViewServiceAccountIn();
